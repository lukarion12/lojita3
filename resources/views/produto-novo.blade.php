...
@section('body')
    ...
    <form action = "/produtos" method="POST" enctype="multipart/form-data">
        ...
        <div class = "form-group">        
            ...
            <input type = "number" class = "form-control" name="qtdProduto" id = "qdt" placeholder = "Nome do Produto">

            <label for="pc">Preço do Produto</label>
            <input type = "number" step="any" class = "form-control" name="pcProduto" id = "pc" placeholder = "Nome do Produto">
